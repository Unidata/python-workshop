...
- *What*: A series of IPython Notebooks on exploring Unidata technology with 
  Python for the 2015 Unidata Training Workshop.
- *When*: <2015-07-20 Tue>--<2015-07-23 Wed>
...
1. [[http://conda.pydata.org/miniconda.html][Install Miniconda (Python 2.7) from Continuum Analytics]].
...
#+BEGIN_SRC shell
conda create -n workshop2015 python=2 numpy netcdf4-python matplotlib cartopy OWSLib siphone MetPy
#+END_SRC
