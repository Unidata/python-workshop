...
From http://code.activestate.com/recipes/502283/, with modifications 
suggest by Jim Pryor (http://code.activestate.com/recipes/502283-read-write-lock-class-rlock-like/#c1)
...
class ReadWriteLock(object):
    ...
    def acquireWrite(self, blocking=True, timeout=True):
        """
